...
src/windows/%.o: ../src/windows/%.cpp
	...
	g++  -D_FILE_OFFSET_BITS=64 -DWXUSINGDLL -D__WXMSW__ -I"D:\Workspace\cplusplus\Learn\libs\WxWidget\include" -I"D:\Workspace\cplusplus\Learn\libs\WxBuild\lib\wx\include\msw-unicode-3.1" -O3 -Wall -c -fmessage-length=0 -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@)" -o "$@" "$<"
